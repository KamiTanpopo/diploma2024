...
<?php if ($authorized): ?>
    <section class="search">
        <div class="container search_container">
            <h3>Choose one specialization</h3>
            <br>
            <div class="specialization__buttons">
                <div class="specialization__button" id="specialization-1">Surgeon</div>
                <div class="specialization__button" id="specialization-2">Traumatologist</div>
                <div class="specialization__button" id="specialization-3">Orthopedist</div>
                <div class="specialization__button" id="specialization-4">Neurosurgeon</div>
                <div class="specialization__button" id="specialization-5">Therapist</div>
                <div class="specialization__button" id="specialization-6">Neurologist</div>
                <div class="specialization__button" id="specialization-7">Cardiologist</div>
                <div class="specialization__button" id="specialization-8">Physiotherapist</div>
                <div class="specialization__button" id="specialization-9">Dentist</div>
            </div>
